...
class ColleaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create colleague" do
    assert_difference('Colleague.count') do
      post colleagues_url, params: { colleague: { email: @colleague.email, first_name: @colleague.first_name, last_name: @colleague.last_name, phone: @colleague.phone, position: @colleague.position, sport: @colleague.sport, team: @colleague.team } }
    end
  ...
  test "should update colleague" do
    patch colleague_url(@colleague), params: { colleague: { email: @colleague.email, first_name: @colleague.first_name, last_name: @colleague.last_name, phone: @colleague.phone, position: @colleague.position, sport: @colleague.sport, team: @colleague.team } }
