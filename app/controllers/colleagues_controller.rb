class ColleaguesController < ApplicationController
  ...
  before_action :correct_user, only: [:edit, :show, :update, :destroy, :colleages]
  ...
  def correct_user
    ...
    redirect_to colleagues_path, notice: "Not Authorized To Edit This Colleague" if @colleague.nil?
  end
  private
    ...
    def colleague_params
      params.require(:colleague).permit(:first_name, :last_name, :sport, :team, :position, :email, :phone, :user_id)
    end
end
